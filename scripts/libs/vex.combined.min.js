...
(function () {
        ...
        return b = !1, a(function () {
            ...
            closeByID: function (d) {
                ...
                return f = c.getVexByID(d), f.length ? (e = f.data().vex.$vex, j = a.extend({}, f.data().vex), g = function () {
                    ...
                    return f.trigger("vexClose", j), e.remove(), a("body").trigger("vexAfterClose", j), j.afterClose ? j.afterClose(f, j) : void 0
                }, i = "none" !== f.css("animationName") && "0s" !== f.css("animationDuration"), b && i ? g() !== !1 && e.unbind(c.animationEndEvent).bind(c.animationEndEvent, function () {
                    return h()
                }).addClass(c.baseClassNames.closing) : g() !== !1 && h(), !0) : void 0
            },
    ...
    a = function (a, b) {
        ...
        return null == b ? a.error("Vex is required to use vex.dialog") : (c = function (b) {
            ...
            NO: {
                text: "Cancel", type: "button", className: "vex-dialog-button-secondary", click: function (a, c) {
            ...
            return c = a.extend({}, b.defaultOptions, d.defaultOptions, c), c.content = d.buildDialogForm(c), f = c.beforeClose, c.beforeClose = function (a, b) {
                return c.callback(b.value), "function" == typeof f ? f(a, b) : void 0
            ...
            return d = a('<div class="vex-dialog-buttons" />'), a.each(c, function (e, f) {
                ...
                return g = a('<button type="' + f.type + '"></button>').text(f.text).addClass(f.className + " vex-dialog-button " + (0 === e ? "vex-first " : "") + (e === c.length - 1 ? "vex-last " : "")).bind("click.vex", function (c) {
                    return f.click ? f.click(a(this).parents(b.getSelectorFromBaseClass(b.baseClassNames.content)), c) : void 0
                }), g.appendTo(d)
            }), d
        }, d)
    }, "function" == typeof define && define.amd ? define(["jquery", "vex"], a) : "object" == typeof exports ? module.exports = a(require("jquery"), require("./vex.js")) : window.vex.dialog = a(window.jQuery, window.vex)
}.call(this);